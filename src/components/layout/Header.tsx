    ...
    >
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          {/* Logo */}
          <a href="#" className="flex items-center gap-2 sm:gap-3" onClick={(e) => handleNavClick(e, "#")}>
            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-primary rounded-xl flex items-center justify-center">
              <span className="text-white font-black text-lg sm:text-xl lg:text-2xl">YK</span>
            </div>
            <span className="text-foreground font-black text-base sm:text-lg lg:text-xl">
              YK Automotive
            </span>
          </a>
              ...
              <nav className="flex flex-col p-6 gap-4">
                {navLinks.map((link) => (
                  <a
                    ...
                    href={link.href}
                    onClick={(e) => handleNavClick(e, link.href)}
                    className="text-foreground hover:text-primary font-semibold text-base transition-colors py-2"
                  >
                    {link.label}
                  </a>
                ))}
